...
sudo apt-get -y --allow-unauthenticated install gdm openbox lxappearance-obconf texlive-full nautilus compton rofi moc texstudio arandr leafpad fontforge lxappearance rxvt-unicode
cd ~/
